...
a_menu_list = ["Работа со списком заметок", "Работа с конкретной заметкой"]
...
while a_ses_exit_allow == "1" :
    ...
    if a_main_act == "1": # Работа со списком заметок
        print("===== Работа со списком заметок =====")
        a_menu_list = ["Режим добавления новой заметки", "Режим отображения всех заметок", "Режим удаления заметки"]
        ...
        # a_menu_list = ["Режим редактирования заметки","Режим работы со статусом заметки","Режим работы с датами заметки"]
        # a_act = ShowAndChooseUserActions(a_menu_list)  # Выведем меню для выбора режима работы
        # Здесь будет поиск заметки по ??? и работа с нею
        # if a_act == "1": # Режим редактирования заметки
        #     NewNote(a_notes, a_note)
